...
const args = argv
  .option([
    ...
    },
    {
      ...
      type: 'string',
      description:
        'When available, an individual token (specified by directory name in tokens) to run test on, defaults to all.',
...
const directories = args.options.token
  ? [`tokens/btc/${args.options.token}`]
  : getDirectories('tokens/btc')
