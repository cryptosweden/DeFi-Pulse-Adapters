...
async function tvl (timestamp, block) {
  ...
  let tokenList = await axios.get(
    'https://api.tranche.finance/api/v1/common/token-address?network=ethereum'
  )
  let holderList = await axios.get(
    'https://api.tranche.finance/api/v1/common/holder-address?network=ethereum'
  )
